Shader "SFS/StripedRim" {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutput o)
		{
			...
			o.Emission = (frac(IN.worldPos.y*10) > _Threshold) ? rimCutoff(rim,_Color1) : rimCutoff(rim,_Color2); // We could have written the whole nested logic statements here but it's clearer with a function
